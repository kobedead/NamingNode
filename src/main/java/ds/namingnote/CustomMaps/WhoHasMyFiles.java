...
public class WhoHasMyFiles<K, V> extends LocalJsonMap_List<K, V> {


    private SyncAgent syncAgent;


    public WhoHasMyFiles(String filepath, SyncAgent syncAgent) {
        super(filepath);
    ...
    public List<V> putSingle(K key, V value) {
        ...
        syncAgent.addWhoHasMyFile(new ReferenceDTO((String) value, (String) key));
        return ret;
    }
